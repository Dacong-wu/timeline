...
!function(e, t) {
    ...
    var F, L, I, j, U, q, D, V, $, X, Y, Z, K, G, J, i = "ScrollSmoother", a = w(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), l = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/, r = (function(e) {
    ...
    function ScrollSmoother(t) {
        ...
        function Za(t, r) {
            S.forEach(function(e) {
                return function adjustEffectRelatedTriggers(e, t, r) {
                    ...
                    var n, o, i, a, s, l, c, f, u = e.pins, d = e.markers;
                    for (c = 0; c < t.length; c++)
                        if (f = t[c],
                        e.trigger && f.trigger && e !== f && (f.trigger === e.trigger || f.pinnedContainer === e.trigger || e.trigger.contains(f.trigger)) && (s = f._startNative || f._startClamp || f.start,
        ...
        function $a() {
            ...
            S.forEach(function(e) {
                ...
                e._startClamp && t < 0 ? (n = (r = e.ratio < 0 ? C() : e.end / e.ratio) - e.end,
                t = 0) : (e.ratio < 0 || e._endClamp && r >= C()) && (n = ((r = C()) - (t = e.ratio < 0 || 1 < e.ratio ? 0 : r - (r - e.start) / e.ratio)) * e.ratio - (e.end - e.start)),
                e.offset = n || 1e-4,
        ...
        function db(r, e, t, n, o) {
            function oc() {
                ...
                s = "auto" === e.value,
                c = s || a && a._startClamp && a.start <= 0 || p.offset ? 0 : a && a._endClamp && a.end === C() ? 1 : .5,
                l && l.kill(),
                l = t && F.to(r, {
                    ease: Y,
                    overwrite: !1,
            ...
            function sc(e) {
                if (s) {
                    ...
                    var t = function _autoDistance(e, t) {
                        var r, n, o = e.parentNode || U, i = e.getBoundingClientRect(), a = o.getBoundingClientRect(), s = a.top - i.top, l = a.bottom - i.bottom, c = (Math.abs(s) > Math.abs(l) ? s : l) / (1 - t), f = -c * t;
                        return 0 < c && (n = .5 == (r = a.height / (I.innerHeight + a.height)) ? 2 * a.height : 2 * Math.min(a.height, Math.abs(-c * r / (2 * r - 1))) * (t || 1),
                        f += t ? -n * t : -n / 2,
                        c += n),
                        {
                            change: c,
            ...
            var i, a, s, l, c, f, u = cb("speed", e, n, r), d = cb("lag", t, n, r), h = F.getProperty(r, "y"), g = r._gsap, p = [], m = [], v = 0;
            return oc(),
            (1 !== i || s || l) && (sc(a = $.create({
                ...
                onUpdate: function onUpdate(e) {
                    var t, r, n, o = h + v * (e.progress - c), i = p.length, a = 0;
                    if (e.offset) {
                        if (i) {
                            for (r = -H,
                            n = e.end; i--; ) {
        ...
        var n, w, e, i, S, a, s, l, c, f, r, u, d, h, g, p = t.smoothTouch, m = t.onUpdate, v = t.onStop, b = t.smooth, T = t.onFocusIn, _ = t.normalizeScroll, x = t.wholePixels, R = this, P = t.effectsPrefix || "", E = $.getScrollFunc(I), k = 1 === $.isTouch ? !0 === p ? .8 : parseFloat(p) || 0 : 0 === b || !1 === b ? 0 : parseFloat(b) || .8, A = k && +t.speed || 1, H = 0, N = 0, M = 1, z = Z(0), O = {
            y: 0
        ...
        this.effects = function(e, t) {
            ...
            t = t || {};
            var r, n, o = t.speed, i = t.lag, a = t.effectsPadding, s = [];
            for (r = 0; r < e.length; r++)
                (n = db(e[r], o, i, r, a)) && s.push(n);
